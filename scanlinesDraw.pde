void scanlinesDraw() {
  ...
  int scanlinesSwitch = scanLight;
    ...
    jitter = noise(jitterCalc);
    jitterCalc = jitterStepSize + jitterCalc;
  ...
  if (scanlinesSwitch == scanLight) {
    ...
    fill(scanlinesSwitch, (map(jitter, 0, 1, -scanlinesAlpha/jitterRange, scanlinesAlpha/jitterRange) + scanlinesAlpha));
